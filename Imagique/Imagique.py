...
class Imagique(QMainWindow):
    def __init__(self):
        super().__init__()

        self.setWindowTitle("Imagique Application")
    ...
    def update_interval(self):
        ...
        self.interval_brightness_value_label.setText("interval of brightness value : {} - {}".format(self.brightness_interval[0], self.brightness_interval[1]))
        self.interval_contrast_value_label.setText("interval of contrast value : {} - {}".format(self.contrast_interval[0], self.contrast_interval[1]))
        self.interval_rotate_value_label.setText("interval of rotation angle : {}° - {}°".format(self.rotate_interval[0], self.rotate_interval[1]))
    ...
    def apply_augmentation_to_selected_image(self):
        ...
        image = Image.open("extras/original_image.jpg")
        ...
        if control and self.label_control:
            ...
            cv2.imwrite("extras/augmented_image.jpg", image)
        ...
        if control2:
            ...
            image = QImage("extras/resized_augmented_image.jpg")
    ...
    def save_parameters_as_json(self):
        ...
        with open('extras/parameters.json', 'w') as json_file:
    ...
    def apply_augmentation_to_all_images(self):
        ...
        if self.bounding_boxes_checkbox.isChecked() and self.label_control:
            ...
            print("this part will never work, suck it")
    ...
    def show_table_function(self) :
        ...
        self.showcsvapp = ShowCSVApp(self.DataFrame)
    ...
    def open_csv(self):
        ...
        self.DataFrame = preprocess_image_labels("extras/dataframe.csv")
    ...
    def open_image(self):
        ...
        if filenames:
            ...
            if control:
                self.image_label.clear()
                image = QImage("extras/resized_original_image.jpg")
                self.image_label.setPixmap(QPixmap.fromImage(image))
